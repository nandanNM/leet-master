  ...
  "inline-flex items-center cursor-pointer justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50  dark:text-secondary-foreground",
  {
    variants: {
      variant: {
        ...
        destructive:
          "gap-2 bg-gradient-to-b from-red-400/80 to-red-500/80 text-sm text-white/90 transition duration-300 ease-in-out hover:bg-gradient-to-b hover:from-red-400/90 hover:to-red-600/80 dark:hover:from-red-400/80 dark:hover:to-red-500/90 active:bg-gradient-to-b active:from-red-400/80 active:to-red-600/80 dark:active:from-red-400 dark:active:to-red-500",
        outline:
